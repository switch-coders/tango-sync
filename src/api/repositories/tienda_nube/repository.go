...
func (r *Repository) SearchStock(ctx context.Context, filter filter.SearchProduct) (*entities.Product, error) {
...
func (r *Repository) UpdateProductVariant(ctx context.Context, product entities.Product) error {
	transaction := newrelic.FromContext(ctx)
